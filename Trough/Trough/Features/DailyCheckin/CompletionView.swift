...
struct CompletionView: View {
    ...
    private let healthItems: [(icon: String, label: String, keyPath: KeyPath<HKSnapshot, String>)] = [
        ("waveform.path.ecg",  NSLocalizedString("checkin.hrv", comment: ""),       \.hrv),
        ("moon.zzz.fill",      NSLocalizedString("checkin.sleep", comment: ""),     \.sleep),
        ("figure.walk",        NSLocalizedString("checkin.steps", comment: ""),     \.steps),
        ("heart.fill",         NSLocalizedString("checkin.restingHR", comment: ""), \.hr),
    ]
    ...
    var body: some View {
            ...
            VStack(spacing: 28) {
                ...
                if let info = vm.cycleInfo {
                    VStack(spacing: 4) {
                        ...
                        Text(NSLocalizedString("checkin.injectionCycle", comment: ""))
                            .font(.caption)
        ...
        .navigationTitle(NSLocalizedString("checkin.saved", comment: ""))
